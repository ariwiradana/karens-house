const gmaps =
   "https://maps.googleapis.com/maps/api/js?key=AIzaSyCvC1wgMf7631iiv1o7kaNXcnswYQ9b59I&callback=mapData&map_ids=8d193001f940fde3";
...
function mapData() {
         ...
         if (response.status_code == 200) {
            ...
            $.each(response.data, function (i, data) {
               ...
               let marker = new google.maps.Marker({
                  ...
                  icon: {
                     url: `https://api-karens-house.000webhostapp.com/icon/view.svg`,
               ...
               $(`#location-all-tab`).append(`
						<div class="map-location-item">
                           ...
                           data.jenis == "food"
							...
							<i class="uil uil-angle-right icon-sm"></i>
						</div>
					`);
            });
   ...
   $(".nav-tabs .nav-item a").click(function () {
      ...
      if (id == "all-tab") {
         ...
         urls = `https://api-karens-house.000webhostapp.com/read-location.php?jenis=${
            id.split("-")[0]
         }`;
      }
